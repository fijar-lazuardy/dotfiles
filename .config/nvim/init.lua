...
-- if not config.kulala then
--   if nvim_lsp['kulala'] ~= nil then
--     if nvim_lsp['kulala'].setup ~= nil  then
--       nvim_lsp['kulala'].setup({
--         capabilities=capabilities,
--       })
--     end
--   end
...
-- vim.api.nvim_set_hl(0, 'TelescopeNormal', {bg='#44475A'})
-- vim.api.nvim_set_hl(0, 'TelescopeBorder', {bg='#44475A'})
