...
() {
  ...
  # as POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND below.CK
  ...
  #typeset -g POWERLEVEL9K_DIR_BACKGROUND=265
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BRANCHFORMAT_FOREGROUND=0
  typeset -g POWERLEVEL9K_VCS_STATUS_LOCAL_BRANCH_FOREGROUND=0
  ...
  #typeset -g POWERLEVEL9K_BATTERY_FORE
